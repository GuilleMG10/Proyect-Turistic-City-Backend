...
async function deleteById(id) {
  ...
  console.log(`🗑️ Documento ${id} eliminado`);
}
...
async function deleteByUserId(userId) {
  ...
  console.log(`🗑️ Documentos del usuario ${userId} eliminados`);
}
...
async function deleteAll() {
  try {
    ...
    console.log("🗑️ Colección eliminada completamente");
  } catch (error) {
...
Comandos:
  ...
  deleteById <id>            🗑️  Elimina un documento por ID
  deleteByUserId <session>   🗑️  Elimina todos los docs de un usuario
  deleteAll                  🗑️  Elimina todo en la colección
`);
  }
})();
