...
import { Bell, Bot, Compass, Menu } from "lucide-react";
...
export default function App() {
  ...
  const navLinks = [
    ...
    { to: '/explore/events', label: 'Eventos' },
    { to: '/explore/for-you', label: 'Para ti' },
    { to: '/explore/calendar', label: 'Calendario' },
    { to: '/explore/map', label: 'Mapa' },
    { to: '/explore/itinerary', label: 'Itinerario' }
  ];
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="md:hidden p-2 -ml-2 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500"
            ...
            <Link 
              to="/" 
              className="flex items-center gap-2 focus:outline-none focus:ring-2 focus:ring-cyan-500 rounded-lg px-2 py-1 group flex-shrink-0"
            >
