    ...
    >
      ...
      >
        ...
        <header className="bg-white dark:bg-gray-800 border-b dark:border-gray-700 p-4 flex items-center justify-between">
          <h2 id="event-form-title" className="text-xl font-semibold text-gray-900 dark:text-white">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          {/* Event Date */}
          <div>
            <label htmlFor="event-date" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 flex items-center gap-2">
          ...
          <div>
            <label htmlFor="event-location" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 flex items-center gap-2">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label htmlFor="event-price" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 flex items-center gap-2">
